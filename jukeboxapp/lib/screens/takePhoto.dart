...
class _TakePhotoState extends State<TakePhoto> {
  ...
  Widget _crearBody() {
    return Column(
      children: [
        Center(
          child: Image(image: AssetImage('assets/animations/selfie.gif',),fit: BoxFit.cover,),
        ),
        SizedBox(height: 20.0,),
        Text("Queremos saber como te sientes",
          style: TextStyle(
  ...
  _procesarImagen(ImageSource origen)async{
    ...
    try {
      final fotoPicker = await picker.getImage(
        source: origen
      );
